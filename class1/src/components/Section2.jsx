...
export const Section2 = () => {
  return (
    <div className="pt-20 px-20 max-sm:pt-10 max-sm:px-10 overflow-x-scroll ">
      <div className="images h-[90vh] w-screen flex gap-10 max-sm:h-[30vh] max-sm:gap-5">
      <div className="i1 bg-black  h-[70vh] w-[45vw] max-sm:h-[30vh] max-sm:w-[45vh] rounded-[4rem] overflow-hidden">
        <img
      ...
      <div className="i2  bg-black  h-[70vh] w-[45vw] max-sm:h-[30vh] max-sm:w-[45vh] rounded-[4rem] overflow-hidden">
        <img
          className="h-full w-full object-cover"
      ...
      <div className="i3  bg-black  h-[70vh] w-[45vw] max-sm:h-[30vh] max-sm:w-[45vh] rounded-[4rem] overflow-hidden">
        <img
          className="h-full w-full object-cover"
      ...
      <div className="i4  bg-black  h-[70vh] w-[45vw] max-sm:h-[30vh] max-sm:w-[45vh] rounded-[4rem] overflow-hidden">
        <img
          className="h-full w-full object-cover"
      ...
      <div className="i5  bg-black  h-[70vh] w-[45vw] max-sm:h-[30vh] max-sm:w-[45vh] rounded-[4rem] overflow-hidden">
        <img
          className="h-full w-full object-cover"
      ...
      <div className="text">
      <p className="text-2xl pt-10 pb-7 pr-40 max-sm:text-sm max-sm:pr-0">
